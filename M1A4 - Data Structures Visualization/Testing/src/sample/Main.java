...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        btn2.setOnAction(e -> {
            ...
            schedule.setX(300);
            schedule.setY(150);
            root1.getChildren().setAll(btn1, btn2, btn3, btn4,btn5,btn6, btn7, btn8, line_top, line_part, textArea, schedule);
        });
        ...
        btn4.setOnAction(e -> {
            textArea.setText("A doubly-link list is creating a playlist\n\n"
                    + "Access: When the playlist is playing you can move backward or forward\n\n"
                    + "Insert: To insert a data you can add it to the first or the last or after an element\n\n"
                    + "Delete: In deleting an element is similar in a sense since you can delete anything inside on the playlist\n\n"
                    + "Search: Same as a playlist when searching a data it can see if the data is in or not\n\n"
